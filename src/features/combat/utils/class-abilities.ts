...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  ranger: [
    ...
    { label: 'Barrage', emoji: '🏹', description: 'Fire a volley of arrows — per-arrow damage scales with DEX, arrow count scales with WIS. Arrow count: 2 base, +1 with DEX≥3, +1 more with WIS≥4 (max 4).', tooltip: 'Volley of arrows. Per-arrow damage scales with DEX, arrow count with WIS.', cpCost: 25, type: 'multi_attack', tier: 2, levelRequired: 10 },
