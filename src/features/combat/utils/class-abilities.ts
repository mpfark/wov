...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  templar: [
    ...
    { label: 'Shield Wall',      emoji: '🛡️', description: '⚓ Stance. Dual-primary: WIS adds bonus block chance (+30% floor, up to +55% at high WIS), CON adds bonus block amount (+5 floor, up to +11 at high CON). Final block chance capped at 95%. Requires a shield equipped to benefit. Click again to drop.', tooltip: 'Boost block chance and amount. Chance scales with WIS, amount with CON. Stance.', cpCost: 25, type: 'block_buff', tier: 2, levelRequired: 10 },
