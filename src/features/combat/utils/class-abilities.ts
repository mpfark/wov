...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  templar: [
    ...
    { label: 'Consecrate',       emoji: '🔆', description: 'Sanctify the ground — heals all party members on this node and burns engaged creatures with holy fire each tick. Heal/burn per tick scales with WIS (35% reduced); number of ticks scales with CON (3 base, +1 at CON≥3, +1 at CON≥6, cap 5 ticks / 10s).', tooltip: 'Heal allies and burn enemies each tick. Heal/burn scales with WIS (35% reduced), ticks with CON.', cpCost: 40, type: 'consecrate', tier: 3, levelRequired: 15 },
