...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  wizard: [
    ...
    { label: 'Arcane Surge', emoji: '✨', description: 'Channel raw arcane energy. All your damage is increased by 15%, and your weapon strikes gain bonus damage from INT.', cpCost: 25, type: 'damage_buff', tier: 2, levelRequired: 10 },
