...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  warrior: [
    ...
    { label: 'Battle Cry', emoji: '📯', description: '⚓ Stance (T2 — reserves 15% of max CP). Reduces incoming damage and softens crits — magnitude scales with STR (with a small shield bonus), duration with DEX. Click again to drop. Reserved CP is NOT refunded.', tooltip: 'Reduce incoming damage and soften crits. Magnitude scales with STR, duration with DEX. Stance.', cpCost: 25, type: 'battle_cry', tier: 2, levelRequired: 10 },
