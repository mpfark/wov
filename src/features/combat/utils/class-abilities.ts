...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  templar: [
    ...
    { label: 'Divine Challenge', emoji: '⚜️', description: 'Take less damage from all sources. Reduction magnitude scales with WIS (17% floor, up to 34% at high WIS), duration scales with CON.', tooltip: 'Take less damage. Reduction scales with WIS, duration with CON.', cpCost: 60, type: 'mitigation_buff', tier: 4, levelRequired: 20 },
  ],
};
