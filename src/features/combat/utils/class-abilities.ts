...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  wizard: [
    ...
    { label: 'Arcane Surge', emoji: '✨', description: '⚓ Stance (T2 — reserves 15% of max CP). All your damage is increased — bonus magnitude scales with INT. Click again to drop. Reserved CP is NOT refunded.', tooltip: 'Increase all your damage. Bonus scales with INT. Stance.', cpCost: 25, type: 'damage_buff', tier: 2, levelRequired: 10 },
    { label: 'Ignite', emoji: '🌋', description: '⚓ Stance (T3 — reserves 20% of max CP). While in combat, an orb pulses each heartbeat at your target — proc chance and spark damage scale with INT, the applied burn DoT (stacks/duration) scales with WIS. Mutually exclusive with Envenom. Click again to drop. Reserved CP is NOT refunded.', tooltip: 'Orbs strike your target and apply burn. Proc/spark scale with INT, burn with WIS. Stance.', cpCost: 50, type: 'ignite_buff', tier: 3, levelRequired: 15 },
  ...
  templar: [
    ...
    { label: 'Divine Challenge', emoji: '⚜️', description: 'Take less damage from all sources. Reduction magnitude scales with WIS, duration scales with CON.', tooltip: 'Take less damage. Reduction scales with WIS, duration with CON.', cpCost: 60, type: 'mitigation_buff', tier: 4, levelRequired: 20 },
  ],
};
