...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  templar: [
    ...
    { label: 'Holy Shield',      emoji: '⚡',  description: '⚓ Stance (T1 — reserves 10% of max CP). Attackers who strike you take holy damage in return (WIS-scaled, once per attacker per tick). Click again to drop. Reserved CP is NOT refunded.', cpCost: 15, type: 'reactive_holy', tier: 1, levelRequired: 5 },
