...
export const CLASS_ABILITIES: Record<string, ClassAbility[]> = {
  ...
  rogue: [
    ...
    { label: 'Envenom', emoji: '🐍', description: '⚓ Stance (T3 — reserves 20% of max CP). Each hit may apply a stackable poison DoT — proc chance scales with DEX, max stack ceiling scales with CHA. Mutually exclusive with Ignite. Click again to drop. Reserved CP is NOT refunded.', tooltip: 'Hits may apply stacking poison. Proc scales with DEX, max stacks with CHA. Stance.', cpCost: 50, type: 'poison_buff', tier: 2, levelRequired: 10 },
