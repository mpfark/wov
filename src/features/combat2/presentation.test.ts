...
describe('safe delivered Combat2 message wording', () => {
  it.each([
    ...
    [{ kind: 'stack_applied', abilityKey: 'envenom', actor: self, target: wolf, amount: 2,
      meta: { stacks: 2, stackNoun: 'poison' } }, 'You apply Envenom to Wolf (2 poison stacks).'],
    [{ kind: 'orb_attack', abilityKey: 'ignite', actor: self, target: wolf, amount: 7,
      hitQuality: 'normal' }, 'An orb from Ignite strikes Wolf for 7 damage.'],
    [{ kind: 'attack', abilityKey: 'eviscerate', actor: self, target: wolf, amount: 18,
      hitQuality: 'normal', meta: { stacksConsumed: 2, stackNoun: 'poison' } },
      'Your Eviscerate consumes 2 poison stacks and deals 18 damage to Wolf.'],
