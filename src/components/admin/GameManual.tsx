            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">⚡ Holy Shield (T1 stance, 15 CP):</strong> <span className="text-soulforged">⚓</span> Reserves 10% of max CP. Each attacker that strikes you takes <code className="text-primary">floor(2 + floor(WIS_mod × 0.8) + CON_kicker + floor(level/4))</code> holy damage in return (max once per attacker per 2s tick). WIS contribution reduced 20%. <em className="text-muted-foreground">Persists until dropped — CP not refunded.</em></p>
                  ...
                  <p><strong className="text-foreground">⚜️ Divine Challenge (T4, 60 CP):</strong> <span className="text-elvish">⚡</span> Subtracts a flat amount from every incoming hit (min 6, up to ~24 at high WIS). Duration 30s + CON. Stacks with Battle Cry / WIS dampen.</p>
