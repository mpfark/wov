            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">⚜️ Divine Challenge (T4, 60 CP):</strong> <span className="text-elvish">⚡</span> Subtracts a flat amount from every incoming hit (min 3, up to ~12 at high WIS). Duration 30s + CON. Stacks with Battle Cry / WIS dampen.</p>
