          ...
          <AccordionItem value="combat" className="border border-border rounded-lg bg-card/50">
            ...
            <AccordionContent className="px-4 space-y-3">
              <div className="space-y-1 text-xs text-muted-foreground">
                ...
                <p><strong className="text-foreground">Shield Block:</strong> When a shield is equipped, <code className="text-primary">min(20%, 5% + √DEX_mod × 2%)</code> chance to block, <p><strong className="text-foreground">Shield Block:</strong> When a shield is equipped, <code className="text-primary">min(20%, 5% + √DEX_mod × 2%)</code> chance to block, reducing damage by <code className="text-primary">round(11 + 2.5 × √STR_mod)</code> flat.</p></p>
            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">📯 Battle Cry (T2, 25 CP):</strong> <span className="text-elvish">⚡</span> Damage Reduction = <code className="text-primary">15% base (20% with shield)</code>, Crit DR = <code className="text-primary">+15% extra on crits</code>, Duration = <code className="text-primary">min(25s, 15s + DEX_mod × 1s)</code>. <em className="text-muted-foreground">Does NOT affect AC or hit chance — reduces damage after hit resolution.</em></p>
                  ...
                  <p><strong className="text-foreground"><p><strong className="text-foreground">🐍 Envenom (T2, 25 CP):</strong> <span className="text-elvish">⚡</span> Poison = <code className="text-primary">floor(DEX_mod × 1.2 × 0.67)</code> per stack per 2s tick (max 5 stacks), 40% apply chance, Duration = <code className="text-primary">min(30s, 20s + DEX_mod × 1s)</code> (buff), stacks last 25s</p> (T2, 25 CP):</strong> <span className="text-elvish">⚡</span> Poison = <code className="text-primary">floor(DEX_mod × 1.2 × 0.67)</code> per stack per 2s tick (max 5 stacks), 40% apply chance, Duration = <code className="text-primary">min(30s, 20s + DEX_mod × 1s)</code> (buff), stacks last 25s</p>
