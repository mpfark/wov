            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">🛡️✨ Force Shield (T1 stance):</strong> <span className="text-soulforged">⚓</span> Reserves 10% of max CP. Maintains an arcane ward with cap ≈ <code className="text-primary">INT_mod + floor(level × 0.5)</code> HP. The shield <strong>does not regenerate during combat</strong> — once depleted, it stays down for the rest of the fight. While <strong>out of combat</strong>, the ward gradually recharges at <code className="text-primary">1 + floor(INT_mod / 2)</code> HP every ~2s up to the cap. Shield HP persists across fights, so jumping into the next pull too soon means a partially-charged ward. <em className="text-muted-foreground">Persists until dropped — CP not refunded.</em></p>
