            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">🛡️ Shield Wall (T2 Stance, 15% max CP reserved):</strong> <span className="text-soulforged">⚓</span> While active, your shield block chance gains a flat +50% (added to your base block chance, capped at 95%). Block amount unchanged. <strong>Requires a shield equipped.</strong> Click again to drop — reserved CP is NOT refunded.</p>
