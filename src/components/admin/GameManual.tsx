            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">🛡️✨ Force Shield (T1 stance, 15 CP):</strong> <span className="text-soulforged">⚓</span> Reserves 10% of max CP. Maintains an arcane absorb shield ≈ <code className="text-primary">INT_mod + floor(level × 0.5)</code> HP that re-forms while active. <em className="text-muted-foreground">Persists until dropped — CP not refunded.</em></p>
