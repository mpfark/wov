            ...
            <AccordionContent className="px-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">🛡️✨ Force Shield (T1 stance):</strong> <span className="text-soulforged">⚓</span> Reserves 10% of max CP. Maintains an arcane ward with cap ≈ <code className="text-primary">INT_mod + floor(level × 0.5)</code> HP. The shield <strong>does not regenerate during combat</strong> — once depleted, it stays down for the rest of the fight. It refills to full automatically when you leave combat, ready for the next encounter. <em className="text-muted-foreground">Persists until dropped — CP not refunded.</em></p>
