...
const SQL=readFileSync('supabase/migrations/20260905233000_combat2_test_arena_admin_contract.sql','utf8').replaceAll('\r\n','\n');
...
describe('Combat2 arena admin contract',()=>{
 ...
 it('keeps the UI RPC-only, guarded by the existing admin route and exact confirmations',()=>{
  ...
  expect(API).toContain("resetPhrase: 'RESET COMBAT2 TEST ARENA'");
