-- Publish the stack-closure support decision without editing the applied gate.
-- The earlier implementation function remains the validation/queue authority;
-- this wrapper removes only the four now-supported stack abilities.
