...
DROP FUNCTION IF EXISTS public.combat2_test_attach_committed_batch();
DROP FUNCTION IF EXISTS public.combat2_test_run_start(uuid,uuid);
DROP FUNCTION IF EXISTS public.combat2_test_run_stop(uuid,uuid);
DROP FUNCTION IF EXISTS public.combat2_test_safe_event(jsonb);
DROP TABLE IF EXISTS public.combat2_test_run_event;
DROP TABLE IF EXISTS public.combat2_test_run_batch;
DROP TABLE IF EXISTS public.combat2_test_run;
