...
-- Add salvage column to characters
ALTER TABLE public.characters ADD COLUMN salvage integer NOT NULL DEFAULT 0;

-- Update restrict_party_leader_updates trigger to secure salvage
...
-- Update award_party_member to also support salvage
CREATE OR REPLACE FUNCTION public.award_party_member(_character_id uuid, _xp integer, _gold integer, _salvage integer DEFAULT 0)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
