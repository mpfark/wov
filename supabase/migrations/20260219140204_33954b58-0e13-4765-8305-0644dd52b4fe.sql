...
-- Allow party leaders to acquire unique items for party members
...
AS $$
BEGIN
  -- Verify caller owns this character OR is party leader of a party containing this character
