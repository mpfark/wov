...
CREATE FUNCTION public.inspect_character_equipment(_character_id uuid)
 RETURNS TABLE(slot text, item_name text, item_type text, rarity text, stats jsonb, hands smallint, durability_pct integer, item_level integer, description text, illustration_url text)
 LANGUAGE sql
