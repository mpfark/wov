-- Templars start with a Sword in main hand (universal gear provides the shield).
INSERT INTO public.class_starting_gear (class, item_id)
SELECT 'templar'::public.character_class, id
FROM public.items
WHERE name = 'Sword'
LIMIT 1
ON CONFLICT DO NOTHING;

-- Mirror CLASS_BASE_HP.templar = 22 in the resource-sync function.
