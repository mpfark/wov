...
import { readCombat2TickTiming } from './time.ts';
...
function decodeCreature(r: Reader, path: string, raw: unknown): SnapshotCreature {
  ...
  return {
    ...
    gold_enabled: r.bool(`${path}.gold_enabled`, o.gold_enabled),
    gold_min: r.num(`${path}.gold_min`, o.gold_min),
    gold_max: r.num(`${path}.gold_max`, o.gold_max),
    gold_chance: r.num(`${path}.gold_chance`, o.gold_chance),
    salvage_enabled: r.bool(`${path}.salvage_enabled`, o.salvage_enabled),
    item_source: r.str(`${path}.item_source`, o.item_source) as SnapshotCreature['item_source'],
    unique_item_id: r.strOrNull(`${path}.unique_item_id`, o.unique_item_id),
    unique_drop_chance: r.numOrNull(`${path}.unique_drop_chance`, o.unique_drop_chance),
